		...
		<form:form modelAttribute="userEditForm" class="form-horizontal" role="form">
			...
			<sec:authorize access="hasRole('ROLE_ADMIN')">
				<div class="form-group">
					...
					<div class="col-lg-10">
						<form:input path="roles" class="form-control" placeholder="Roles"></form:input>
						<form:errors cssClass="error" path="roles"></form:errors>
						<p class="help-block">Enter roles of the user separated by commas.</p>
					</div>
				</div>
			</sec:authorize>
